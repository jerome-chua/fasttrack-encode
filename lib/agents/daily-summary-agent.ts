...
const getTodaysFoodLogs = new FunctionTool({
  name: "get_todays_food_logs",
...
export const dailySummaryAgent = new LlmAgent({
  name: DAILY_SUMMARY_AGENT_NAME,
  model: "gemini-2.5-flash",
  description: "Generates daily nutrition summaries based on today's food logs.",
  instruction: DAILY_SUMMARY_INSTRUCTION,
  tools: [getUserProfile, getTodaysFoodLogs],
});
