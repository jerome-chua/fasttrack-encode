/**
 * Insights Agent - Mastra Implementation
 *
 * Provides personalized health insights based on user data and The Obesity Code principles.
...
const getWeightHistoryTool = createTool({
  id: "get_weight_history",
...
const getFastingHistoryTool = createTool({
  id: "get_fasting_history",
...
const getFoodLogsTool = createTool({
  id: "get_food_logs",
...
export const insightsAgent = new Agent({
  id: INSIGHTS_AGENT_NAME,
  name: "Health Insights",
  model: groqProvider(GROQ_TEXT_MODEL),
  instructions: INSIGHTS_AGENT_INSTRUCTION,
  tools: {
    getUserProfile: getUserProfileTool,
    getWeightHistory: getWeightHistoryTool,
    getFastingHistory: getFastingHistoryTool,
    getFoodLogs: getFoodLogsTool,
  },
});
